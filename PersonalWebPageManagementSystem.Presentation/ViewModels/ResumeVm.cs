...
namespace PersonalWebPageManagementSystem.Presentation.ViewModels
{
    public class ResumeVm
    {
        ...
        public List<ResumeExperienceVm> EmploymentHistory { get; set; } = new();
        public List<ResumeEducationVm> Education { get; set; } = new();
        public List<ResumeSkillVm> Skills { get; set; } = new();
    }
}
